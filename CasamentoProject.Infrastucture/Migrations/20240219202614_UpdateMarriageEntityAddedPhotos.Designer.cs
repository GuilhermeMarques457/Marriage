...
namespace CasamentoProject.Infrastucture.Migrations
{
    ...
    [Migration("20240219202614_UpdateMarriageEntityAddedPhotos")]
    partial class UpdateMarriageEntityAddedPhotos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CasamentoProject.Core.Domain.Entities.GiftMoney", b =>
                {
                    ...
                    b.ToTable("GiftsMoney", (string)null);
                });
            ...
            modelBuilder.Entity("CasamentoProject.Core.Domain.Entities.Marriage", b =>
                {
                    ...
                    b.Property<string>("PhotoOfBridePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhotoOfCouplePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PhotoOfGroomPath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CasamentoProject.Core.Domain.Entities.FamilyMember", b =>
                {
                    b.HasOne("CasamentoProject.Core.Domain.Entities.Guest", null)
            ...
            modelBuilder.Entity("CasamentoProject.Core.Domain.Entities.Guest", b =>
                {
                    b.HasOne("CasamentoProject.Core.Domain.Entities.Marriage", null)
